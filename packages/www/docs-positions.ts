export const docsPositions = [
  ...
  "docs/guides/video-on-demand/index.mdx",
  ...
  "docs/guides/video-nfts/index.mdx",
  "docs/guides/video-nfts/mint-a-video-nft.mdx",
  "docs/guides/video-nfts/build-a-video-nft-app.mdx",

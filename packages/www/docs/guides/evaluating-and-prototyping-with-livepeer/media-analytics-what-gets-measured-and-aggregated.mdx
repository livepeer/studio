...
[Quality of Service](https://www.streamingmedia.com/Articles/ReadArticle.aspx?ArticleID=145718).
For measuring what's often called Quality of Experience, your custom
...
Livepeer.com, your chosen media player, and your custom app.
...
from the Livepeer Video REST API. It should be a straightforward exercise to
associate those 2 Livepeer Video identifiers with the JW Media player's
Analytics ID. Upon doing so, you now have a bridge between Livepeer's Quality of
Service analytics and your media player's Quality of Experience analytics.
You're consequently able to answer questions like: What Livepeer.com service

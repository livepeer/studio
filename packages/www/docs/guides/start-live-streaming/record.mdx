...
```bash
{
    ...
    "recordingURL":"https://mdw-livepeercdn.monster/recordings/mnopa1c9-1775-4797-919e-40d21099d02b/index.m3u8",
    "mp4URL":"https://mdw-livepeercdn.com/recordings/mnopa1c9-1775-4797-919e-40d21099d02b/2021_05_04_02_00_31-source.mp4",
    {other asset object keys}
}
```

...
Livepeer.com Dashboard, navigate to the streams list page,
[livepeer.com/app/user](/app/user), and click on a stream name. Update the
Record Sessions radio button, and all new sessions will adopt the updated
recording setting. In progress sessions will not start/stop recording though.

...
[livepeer.com/dashboard/streams](https://livepeer.com/dashboard/streams), located in the left-hand menu. Click on the "+ Create stream" button on the top right corner. When you name
...
4. Navigate to the stream detail page, click the “Reveal stream key”

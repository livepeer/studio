...
<DocsGrid cols={3}>
    <NavigationCard href='/docs/guides/start-live-streaming/tutorial#create-a-stream' title='Create a stream' label='Jump to section' />
    <NavigationCard href='/docs/guides/start-live-streaming/tutorial#broadcast-live-video-using-obs' title='Broadcast live video using OBS' label='Jump to section' />
    <NavigationCard href='/docs/guides/start-live-streaming/tutorial#playback-your-live-stream' title='Playback your live stream' label='Jump to section' />
</DocsGrid>

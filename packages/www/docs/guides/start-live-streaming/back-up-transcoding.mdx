...
3. Playback from:
   `https://[region]-livepeercdn.com/hls/[playbackId]/index.m3u8`.
...
[
  {
    ...
    playback: "https://{nearbyRegion}-livepeercdn.com/hls"
  }
];
```
...
[
   {
      ...
      "playback":"https://{region-1}-livepeercdn.com/hls",
      "base":"https://{region-1}-livepeercdn.com"
   },
   {
      "ingest":"rtmp://{region-2}-rtmp.livepeer.com/live",
      "playback":"https://{region-2}-livepeercdn.com/hls",
      "base":"https://{region-2}-livepeercdn.com"
   },
   {
      "ingest":"rtmp://{region-3}-rtmp.livepeer.com/live",
      "playback":"https://{region-3}-livepeercdn.com/hls",
      "base":"https://{region-3}-livepeercdn.com"
   }
]
```

...
3. Playback from:
   `https://[region]-cdn.livepeer.com.com/hls/[playbackId]/index.m3u8`.
...
[
  {
    ...
    playback: "https://{nearbyRegion}-cdn.livepeer.com.com/hls"
  }
];
```
...
[
   {
      ...
      "playback":"https://{region-1}-cdn.livepeer.com.com/hls",
      "base":"https://{region-1}-cdn.livepeer.com.com"
   },
   {
      "ingest":"rtmp://{region-2}-rtmp.livepeer.com/live",
      "playback":"https://{region-2}-cdn.livepeer.com.com/hls",
      "base":"https://{region-2}-cdn.livepeer.com.com"
   },
   {
      "ingest":"rtmp://{region-3}-rtmp.livepeer.com/live",
      "playback":"https://{region-3}-cdn.livepeer.com.com/hls",
      "base":"https://{region-3}-cdn.livepeer.com.com"
   }
]
```

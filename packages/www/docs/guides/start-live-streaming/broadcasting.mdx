...
- Login to the Livepeer.com Dashboard, navigate to the streams list page, [livepeer.com/dashboard/streams](https://livepeer.com/dashboard/streams), and click on a stream name. Reveal and copy your secret stream key.

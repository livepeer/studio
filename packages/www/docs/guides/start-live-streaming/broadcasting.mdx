...
metaTitle: Configure broadcast software - Livepeer.com
metaDescription: Configure broadcast software to stream with Livepeer.com
---
...
- JavaScript + axios
 ```javascript
//Getting stream key from stream ID
const axios = require('axios');

axios.get("https://livepeer.com/api/{id}", )
.then(res => {
...
Livepeer.com works best with consistent, short keyframe intervals, ideally 2
seconds.

...
axios
  .get("https://livepeer.com/api/multistream/target", {
    headers: {
      Authorization: "Bearer {api_key}",
    },
  })
...
axios.patch("https://livepeer.com/api/multistream/target/{id}", {
  headers: {
    'Authorization': 'Bearer {api_key}',
    'Content-Type': 'application/json'
  },
...
axios
  .delete("https://livepeer.com/api/multistream/target/{id}", {
    headers: {
      Authorization: "Bearer {api_key}",
      "Content-Type": "application/json",
    },
...
axios
  .patch("https://livepeer.com/apt/stream/{id}", {
    headers: {
      Authorization: "Bearer {api_key}",
      "Content-Type": "application/json",
    },

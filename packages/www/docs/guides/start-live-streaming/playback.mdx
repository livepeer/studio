...
The easiest way to the stream playback URL is to login to the Livepeer.com Dashboard, navigate to the Streams page, [livepeer.com/dashboard/streams](https://livepeer.com/dashboard/streams), and click on a stream name. The playback URL is listed on the page.

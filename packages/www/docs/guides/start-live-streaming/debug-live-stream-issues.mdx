...
We will use the [test player](/app/test-player) to debug. You must be logged
into the Livepeer Studio dashboard.
...
Load your playback URL in the [test player](/app/test-player). If you get a
"Stream not found" error, confirm that your URL is correct. It should look
...
Does anything playback in the [test players](/app/test-player)?
...
Check the stream status below the test player. Is it active?

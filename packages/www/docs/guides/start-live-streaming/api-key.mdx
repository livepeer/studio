...
description: Get a Livepeer Studio API key
metaTitle: Get an API key - Livepeer Studio
metaDescription: Get a Livepeer Studio API key
---
...
is the sole secret you will have to use when making requests to the Livepeer
Studio API, so share and store it with caution.

Login to the Livepeer Studio Dashboard, and navigate to
...
## How to get an API Key using the Livepeer Studio Dashboard

Make sure you register Livepeer Studio Account and get an API Key

- Create a free
  [Livepeer Video Service Account](https://livepeer.studio/register)
...
quickly with the API, you can also create an API key with CORS access enabled.
API keys created with that option can be used from the browser, from any origin
that you configure it for.

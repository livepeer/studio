...
![Api Guide 1](/img/docs/api-guide1.png)

- Click `Create API Key`

![Api Guide 1](/img/docs/api-guide2.png)
...
We currently allow you to reveal the secret of any existing API key but this behavior may change in the future, so

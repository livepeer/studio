...
Login to the Livepeer.com Dashboard, and navigate to the Developers tab, [livepeer.com/dashboard/developers/api-keys](https://livepeer.com/dashboard/developers/api-keys). On this page, you can create, delete and find out the most recent usage of your API keys.

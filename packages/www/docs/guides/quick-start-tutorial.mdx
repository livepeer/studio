...
for using Livepeer.com is to be able to create an RTMP or SRT stream.
...
Prefer to learn via video? See this blog post [Stream into Livepeer.com for the First Time](https://livepeer.com/blog/video-tutorial-stream-into-livepeer-for-the-first-time) for this topic's content in video form.

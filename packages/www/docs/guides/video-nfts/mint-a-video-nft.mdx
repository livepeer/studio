...
description: Learn how to mint a Video NFT with Livepeer Studio
metaTitle: Mint a Video NFT - Livepeer Studio
metaDescription: Learn how to mint a Video NFT with Livepeer Studio
---
...
[Build a Video NFT app](https://livepeer.studio/docs/guides/video-nfts/build-a-video-nft-app)
guide instead.
...
Start by getting an API key to use from the tool:
...
Ok to proceed? (y) y
? Enter your API key (learn more at http://bit.ly/lp-api-key): ********
****************************

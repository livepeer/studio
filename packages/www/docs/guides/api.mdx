...
The Livepeer.com API is a video live streaming API. With the Livepeer.com API, you or the client can configure details for live broadcasting software, generate a playback URL for stream viewers, get usage data about your stream sessions and more. Explore the [Livepeer.com API reference](/docs/api-reference) for more information.
...
`5XX` = internal server error, problem with Livepeer servers. Visit https://livepeer.statuspage.io/ for more information. 

...
const response = await axios.post("https://livepeer.com/api/asset/import", {
  headers: {
...
const updateAsset = async () => {
  const response = await axios.patch(
    "https://livepeer.com/api/asset/$ASSET_ID",
    {
      headers: {
        Authorization: `Bearer ${process.env.LP_API_KEY}`,
        "Content-Type": "application/json",
...
const deleteAsset = async () => {
  const response = await axios.delete("https://livepeer.com/api/asset/{id}", {
    headers: {
      Authorization: `Bearer ${process.env.LP_API_KEY}`,
    },
  });

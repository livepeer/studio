...
to call the VOD API. If you're planning on calling the API from the frontend,
create an API key with
[CORS access allowed](https://livepeer.studio/docs/guides/start-live-streaming/api-key#cors).
...
When the video is uploaded, a response with an empty body and a status code of
`200 OK` should be returned.

- If you want to track the status of your upload, you can use the `task`

---
title: List Tasks
description: Livepeer Studio API Reference | List Tasks
metaTitle: List Tasks - Livepeer Studio
metaDescription: Livepeer Studio API Reference | List Tasks
---
...
axios
  .get("https://livepeer.studio/api/task", {
    headers: {

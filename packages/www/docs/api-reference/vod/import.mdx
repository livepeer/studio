...
description: Livepeer Studio API Reference | Import
metaTitle: Import - Livepeer Studio
metaDescription: Livepeer Studio API Reference | Import
---
...
axios
  .post("https://livepeer.studio/api/asset/import", {
    headers: {
      data: JSON.stringify({
        url: "$EXTERNAL_URL",
        name: "Example name",

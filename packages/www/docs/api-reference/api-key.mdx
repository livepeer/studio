...
Login to the Livepeer.com Dashboard, and navigate to the API Keys tab, [livepeer.com/app/user/keys](/app/user/keys). On this page, you can create, delete and find out the most recent usage of your API keys.

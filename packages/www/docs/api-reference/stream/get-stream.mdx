...
description: Livepeer Studio API Reference | GET retrieve a stream
metaTitle: GET retrieve a stream - Livepeer Studio
metaDescription: Livepeer Studio API Reference | GET retrieve a stream
---

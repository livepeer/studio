---
title: Overview
description: Livepeer Studio API Reference | The stream Object
metaTitle: Overview - Livepeer Studio
metaDescription: Livepeer Studio API Reference | The stream Object
---
...
<Table
  data={[
    ...
    },
    {
      ...
      type: <code>string</code>,
      description:
        "Unique identifier for the Livepeer Studio user account that created the stream object.",
    },
  ]}
/>

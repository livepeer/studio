...
description: Livepeer Studio API Reference | GET a list of targets
metaTitle: GET a list of targets - Livepeer Studio
metaDescription: Livepeer Studio API Reference | GET a list of targets
---

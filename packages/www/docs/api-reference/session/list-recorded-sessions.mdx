...
description: Livepeer Studio API Reference | GET a list of recorded sessions
metaTitle: GET a list of recorded sessions - Livepeer Studio
metaDescription: Livepeer Studio API Reference | GET a list of recorded sessions
---

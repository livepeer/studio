...
<DocsGrid cols={3}>
    <NavigationCard href='/docs/video-guides/start-live-streaming/create-a-stream#no-code-stream-creation' title='No code stream creation in the Livepeer.com Dashboard' label='Jump to section' />
    <NavigationCard href='/docs/video-guides/start-live-streaming/create-a-stream#create-a-stream-object-with-a-post-request-to-the-api' title='Create a stream object with a POST request' label='Jump to section' />
</DocsGrid>

### No code stream creation

...
<DocsGrid cols={3}>
    <NavigationCard href='/docs/video-guides/start-live-streaming/create-a-stream#no-code-stream-creation-with-the-livepeercom-dashboard' title='No code stream creation in the Livepeer.com Dashboard' label='Jump to section' />

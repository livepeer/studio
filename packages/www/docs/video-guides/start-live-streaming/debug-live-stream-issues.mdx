...
Read this [guide](/docs/video-guides/start-live-streaming/playback) to find your live stream playback URL. 
...
Check if you are transcoding. Is nothing listed next to

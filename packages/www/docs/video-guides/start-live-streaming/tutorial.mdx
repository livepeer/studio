...
<DocsGrid cols={3}>
    <NavigationCard href='/docs/video-guides/start-live-streaming/tutorial#create-a-stream' title='Create a stream' label='Jump to section' />
    <NavigationCard href='/docs/video-guides/start-live-streaming/tutorial#broadcast-live-video-using-obs' title='Broadcast live video using OBS' label='Jump to section' />
    <NavigationCard href='/docs/video-guides/start-live-streaming/tutorial#playback-your-live-stream' title='Playback your live stream' label='Jump to section' />
</DocsGrid>

### Create a stream

Login to the Livepeer.com Dashboard, and navigate to the streams list page, [livepeer.com/app/user](https://livepeer.com/app/user). Click on the Create button. When you name your stream, pick a unique name and include URL compatible characters only.

...
description: Livepeer.com getting started tutorial (no code required)
---

# Start live streaming with Livepeer.com (no code required)
...
<DocsGrid cols={3}>
    <NavigationCard href='/' title='Create a stream' label='Jump to section' />
    <NavigationCard href='/' title='Broadcast live video using OBS' label='Jump to section' />
    <NavigationCard href='/' title='Playback your live stream' label='Jump to section' />
</DocsGrid>
...
4. Navigate to the stream detail page, click the “Show secret stream key” button, and copy the stream key ![Livepeer.com Dashboard secret stream key button](/img/docs/secret-stream-key.png)

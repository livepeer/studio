...
import { Cross1Icon as Close } from "@radix-ui/react-icons";
...
const Cell = ({ children }) => {
  return <Box css={{ m: "0.4em" }}>{children}</Box>;
};
      ...
      <Box css={{ p: "$6" }}>
        ...
        {stream ? (
                    ...
                    <Flex>
                      ...
                      <CopyToClipboard
                        ...
                        <Flex
                          ...
                          />
                          {!!isCopied && (
                            <Box css={{ fontSize: 12, color: "$hiContrast" }}>
                              Copied
                            </Box>
                          )}
                        </Flex>
          ...
          <Flex css={{ justifyContent: "center", alignItems: "center" }}>
            {/* <Spinner css={{ mr: "1em" }} /> */}
            <Box css={{ color: "$hiContrast" }}>Loading</Box>
          </Flex>
        )}
      </Box>
    </Layout>

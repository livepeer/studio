...
experience with the minimum latency Livepeer.com can provide. These global URLs
are the best option for nearly all Livepeer.com users.
...
viewer locations to provide the optimal Livepeer.com experience. Some
...
Next, learn
[how to setup a CNAME for the Livepeer.com global ingest URL](/docs/guides/api/cname).

...
Create a `stream` object to create a livestream with configuration details for live broadcasting software and generate a playback URL for stream viewers.

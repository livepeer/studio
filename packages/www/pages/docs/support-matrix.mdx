...
| **Non-CDN Delivery** | Non-CDN delivery for free tier users is limited to 50mbps per account, roughly equals to 10 viewers in HD. 
| |Additional viewers will automatically be served in 240p. |

...
export const rowsPageFromState = async (
  state: State<ClipsTableData>,
  userId: string,
  getStreamSessionsByUserId: Function,
  openSnackbar: Function
): Promise<RowsPageFromStateResult<ClipsTableData>> => {
...
export const makeEmptyState = () => (
  <TableEmptyState
    title="No clips"
    description="New clips are created from running stream session calling the clip api."
    learnMoreUrl="https://docs.livepeer.studio/reference/api/create-clip"
  />
);

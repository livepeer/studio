  ...
  <Box
    ...
    <g fill="none">
      <Box
        ...
        fill="#A3ACB9"
        className="sidebar-nav-icon-path-1"
      />
      <Box
        as="path"
...
export const BillingIcon = ({ active = false }) => (
  <svg
    height="16"
    viewBox="0 0 16 16"
    width="16"

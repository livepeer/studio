              ...
              <Box
                ...
                <Box css={{ mt: "$9", maxWidth: 600, pb: "$2" }}>
                  <Box css={{ mb: "$7", fontSize: "$4" }}>
                    ...
                    Studio empowers developers to build video-enabled
                    applications that give creators total control over their
                    content with no middlemen.
                  </Box>
                  <Flex align="center">
            ...
            <Box>
              <Box css={{ mb: "$5" }}>
                ...
                <Text
                  ...
                  easy for builders to create new video experiences and access
                  the decentralized Livepeer network. More than a product,
                  Livepeer Studio is a growing community of web3 developers and
                  creators creating the future of web3 video.
                </Text>
              </Box>
              <Box css={{ mb: "$9" }}>
                <Heading
                ...
                <Text
                  ...
                  reliable infrastructure that can handle today's high demand
                  for video processing. Livepeer's decentralized network
                  includes over 70,000 GPUs and currently processes millions of
                  minutes a week.
                </Text>
              </Box>
              <Heading

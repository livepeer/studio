...
export default function Colors() {
  ...
  const [textBlocks, setTextBlocks] = useLocalStorage(
    "colors-textBlocks",
    true
  );
  const [alphaValues, setAlphaValues] = useLocalStorage(
    "colors-alphaValues",
    true
  );
    ...
    <>
      <Section
        ...
        <Container size="3" css={{ mb: "$5" }}>
          <Box>
            <Checkbox
              defaultChecked={palette}
              onChange={(e) => setPalette(e.target.checked)}>
              Palette
            </Checkbox>
            <Checkbox
              defaultChecked={layers}
              onChange={(e) => setLayers(e.target.checked)}>
              Layers
            </Checkbox>
            <Checkbox
              defaultChecked={buttons}
              onChange={(e) => setButtons(e.target.checked)}>
              Buttons
            </Checkbox>
            <Checkbox
              defaultChecked={buttons}
            ...
            <Checkbox
              defaultChecked={textBlocks}
              onChange={(e) => setTextBlocks(e.target.checked)}>
              Text Blocks
            </Checkbox>
            <Separator css={{ my: "$3" }} />
            <Checkbox
    ...
    <Container size="3" css={{ my: "$9" }}>
      <Grid css={{ gridTemplateColumns: "repeat(4, 1fr)", gap: "$5" }}>
        {colors.map((color) => (
          <Box
            key={color}
            css={{ "&[class] * + *": { ml: "$2", verticalAlign: "top" } }}>
      ...
      <Grid
        css={{ gridTemplateColumns: "repeat(8, 1fr)", gap: "$5", mt: "$9" }}>
        {colors.map((color) => (
          <Box
            key={color}
            css={{ "&[class] * + *": { ml: "$2", verticalAlign: "top" } }}>
    ...
    <Container size="3" css={{ mb: "$9" }}>
      <Grid
        ...
        {colors.map((color) => (
          <Box
            key={color}
            css={{ p: "$4", borderRadius: "$3", bc: `$${color}9` }}>
    ...
    <Box css={{ mb: "$9" }}>
      {colors.map((color) => {
        ...
        return (
          <Box
            key={color}
            css={{ "html.gap &": { display: "grid", gap: "$5" } }}>
            ...
            <Box css={{ bc: color9, p: 200 }}>
              <Container size="3">
                ...
                <Text
                  size="3"
                  css={{ lineHeight: "25px", color: getHiContrast(color) }}>
                  {text}
                </Text>
              </Container>
            </Box>
    ...
    <Container size="3">
      <Box css={{ mb: "$9", "html.gap &": { display: "grid", gap: 2 } }}>
        <Grid css={gridStyle}>
          ...
          <Text css={{ color: "$gray9", fontSize: "$2", ta: "center" }}>
            10
          </Text>
          <Text css={{ color: "$gray9", fontSize: "$2", ta: "center" }}>
            11
  ...
  return (
    <Box>
      <Text
        size="2"
        as="label"
        css={{ display: "inline-block", lineHeight: "20px" }}>
        <input
          type="checkbox"
          style={{

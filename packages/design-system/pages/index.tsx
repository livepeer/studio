...
import { Table, Caption, Thead, Tbody, Tfoot, Tr, Th, Td } from "../";
...
import { RadioCardGroup, RadioCard } from "../";
        ...
        <Section size="3">
          ...
          <Container size="2" css={{ my: "$9" }}>
            <Paragraph>
              ...
              case for this container size is longform text. So we're previewing
              some longform text here so we can make sure the container width
            ...
            <Grid
              ...
              <Box>
                <Text as="p" size="4" css={{ lineHeight: "27px" }}>
                  ...
                  because one common use case for this container size is a 3-up
                  grid.
                </Text>
              </Box>
              <Box>
          ...
          <Container size="2">
            ...
            <Flex css={{ fd: "column", gap: "$4" }}>
              ...
              <Paragraph size="2">
                ...
                Prototype with real components. Handoff production code.
              </Paragraph>
              <Paragraph size="1">
                ...
                longform text. So we're previewing some longform text here so we
                can make sure the container width provides an optimal line
          ...
          <Container size="2">
            ...
            <Flex css={{ ai: "flex-start", gap: "$6", mt: "$6" }}>
              ...
              <TextArea
                ...
                placeholder="Size 1"
                readOnly
                defaultValue="eihuweofjew"></TextArea>
            </Flex>
          </Container>
        </Section>
        <Flex css={{ jc: "center" }}>

---
title: Overview
description: Livepeer Studio API Reference | The multistream target object
metaTitle: Overview - Livepeer Studio
metaDescription: Livepeer Studio API Reference | The multistream target object
---
...
[`Multistream`](/guides/start-live-streaming/multistream) guide.
...
<Table
  data={[
    ...
    },
    {
      ...
      type: <code>string</code>,
      description:
        "Unique identifier for the Livepeer Studio user account that created the multistream target object.",
    },
    {

...
description: Livepeer Studio API Reference | GET retrieve a session
metaTitle: GET retrieve a session - Livepeer Studio
metaDescription: Livepeer Studio API Reference | GET retrieve a session
---

...
description: Verify your Livepeer Studio stream is active
metaTitle: Verify a live stream is active - Livepeer Studio
metaDescription: Verify your Livepeer Studio stream is active
---
...
## Verify stream status with the Livepeer Studio API

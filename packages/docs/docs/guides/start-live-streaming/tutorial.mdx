...
metaTitle: Getting started tutorial - Livepeer Studio
metaDescription: Start live streaming with Livepeer Studio
---

# Start live streaming with Livepeer Studio

There are multiple ways to livestream with Livepeer Studio. The only
prerequisite for using Livepeer Studio is to be able to create an RTMP stream.

You can integrate your streaming application directly with the Livepeer Studio
API. Or you can use the Livepeer Studio Dashboard to live stream without writing
any code.
...
Next, let’s configure OBS to point to Livepeer Studio’s RTMP ingest data
centers.
...
Navigate to your stream detail page in the Livepeer Studio Dashboard, and copy
the Playback URL. The playback URL is an M3U8 file, the basis for the HTTP Live
Streaming (HLS) format.

Livepeer Studio doesn’t have it’s own player, but works with open source and 3rd
...
That’s it! Streaming with Livepeer Studio is that simple. To get in touch, fill
out a [contact form](https://livepeer.com/contact).

_[Video Tutorial : Stream into Livepeer Studio for the First Time](https://livepeer.com/blog/video-tutorial-stream-into-livepeer-for-the-first-time)_

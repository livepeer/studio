...
metaTitle: Multistream - Livepeer Studio
...
## Managing Multistream targets in the Livepeer Studio Dashboard
...
## Managing Multistream targets with the Livepeer Studio API
...
details in the [API reference](/references/multistream-target/overview).
...
##### Request: [`POST /api/multistream/target`](/references/multistream-target/create-target)
...
##### Request: [`GET /api/multistream/target/{id}`](/references/multistream-target/get-target)
...
##### List Request: [`GET /api/multistream/target`](/references/multistream-target/list-targets)
...
##### Request: [`PATCH /api/multistream/target/{id}`](/references/multistream-target/update-target)
...
##### Request: [`DELETE /api/multistream/target/{id}`](/references/multistream-target/delete-target)
...
[Delete `Multistream Target` API](/references/multistream-target/delete-target).
